...
<div class="hidden md:block w-3/12 border border-slate-500 rounded-lg m-4 bg-gray-50 px-4 py-2">
	...
	<div class="text-center w-full text-sm">
		<p>
			<a class="hover:underline" href="https://nostr.cooking"
				>NOSTR.COOKING</a
			>
		</p>
		<p>open source on <a class="hover:underline" href="https://github.com/github-tijlxyz/nostr.cooking">github</a></p>
	</div>
</div>
